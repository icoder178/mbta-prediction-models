...
def write_to_file(data):
    ...
    for i in range(len(data)):
        gse_data.append([model_list[i%10],"No Additional Data",data[i][0]])
        gse_data.append([model_list[i%10],"Any Data",data[i][1]])
        delay_data.append([model_list[i%10],"No Additional Data",data[i][2]])
        delay_data.append([model_list[i%10],"Any Data",data[i][3]])
